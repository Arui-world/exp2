    ...
    , ui(new Ui::MainWindow)
{
   ...
   // on_actionL_triggered(false);

    connect(ui->actionL,SIGNAL(triggered(bool)),ui->textEdit,SLOT(hideLineNumberArea(bool)));
}
...
void MainWindow::on_actionFontBackgroudColor_triggered()
{
...
// void MainWindow::on_actionL_triggered(bool checked)
// {
